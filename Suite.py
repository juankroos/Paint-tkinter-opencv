...
class PaintApp:
    ...
    def create_menu(self):
        ...
        view_menu.add_radiobutton(label="Plain", variable=self.sheet_type_var, value="Plain", command=self.change_sheet_type)
        view_menu.add_radiobutton(label="Grid", variable=self.sheet_type_var, value="Grid", command=self.change_sheet_type)
    ...
    def change_sheet_type(self):
        # Ajoutez ici le code pour changer le type de feuille de dessin en fonction de la valeur sélectionnée
